...
namespace QnSBillShare.WebApi.Controllers
{
	...
	using System.Collections.Generic;
	using System.Threading.Tasks;
	using Contract = QnSBillShare.Contracts.Business.App.IBillExpenses;
	using Model = Transfer.Business.App.BillExpenses;
	[ApiController]
	[Route("Controller")]
	public partial class BillExpensesController : GenericController<Contract, Model>
	{
		[HttpGet("/api/[controller]/MaxPage")]
		public Task<int> GetMaxPageAsync()
		{
