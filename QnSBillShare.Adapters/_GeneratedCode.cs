	...
	public static partial class Factory
	{
		public static Contracts.Client.IAdapterAccess<I> Create<I>() where I : Contracts.IIdentifiable
		{
			...
			if (Adapter == AdapterType.Controller)
			{
				...
				{
					result = new Controller.GenericControllerAdapter<QnSBillShare.Contracts.Business.App.IBillExpenses>() as Contracts.Client.IAdapterAccess<I>;
				}
			...
			else if (Adapter == AdapterType.Service)
			{
				...
				{
					result = new Service.GenericServiceAdapter<QnSBillShare.Contracts.Business.App.IBillExpenses, Transfer.Business.App.BillExpenses>(BaseUri, "BillExpenses") as Contracts.Client.IAdapterAccess<I>;
				}
				else if (typeof(I) == typeof(QnSBillShare.Contracts.Business.Account.ILoginUser))
				{
